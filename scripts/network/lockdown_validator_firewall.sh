...
############################################################
# Lumen — Lock down validator firewall (iptables)
#
# This helper is intended to run on the validator host.
# It:
...
echo "=== Lumen validator firewall lockdown ==="
...
# Flush existing rules and set policies
iptables -F
iptables -X
