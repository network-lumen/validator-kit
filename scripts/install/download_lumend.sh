...
#       https://github.com/network-lumen/blockchain/releases/download/v1.3.0/linux-amd64-v1.3.0.tar.gz
...
RELEASE_TAG="${LUMEN_RELEASE_TAG:-v1.3.0}"
...
if [[ -f "${TMP_DIR}/lumend" ]]; then
  ...
  # (e.g. linux-amd64-v1.3.0). Prefer any executable that looks
